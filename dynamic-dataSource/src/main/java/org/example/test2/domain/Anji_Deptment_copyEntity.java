...
@Data
  @EqualsAndHashCode(callSuper = false)
    @TableName("deptment_copy")
@ApiModel(value="Anji_Deptment_copyEntity对象", description="")
public class Anji_Deptment_copyEntity extends Model<Anji_Deptment_copyEntity> {
