...
//        dsc.setDriverName("com.mysql.jdbc.Driver");
      dsc.setDriverName("com.mysql.cj.jdbc.Driver"); //mysql8.0使用
        ...
        dsc.setUrl("jdbc:mysql://172.16.0.20:3306/anji_usermanager?useSSL=true&characterEncoding=UTF-8&serverTimezone=UTC&nullCatalogMeansCurrent=true&allowMultiQueries=true");
...
//        System.err.println(mpg.getCfg().getMap().get("abc"));
    ...
    public static PackageConfig getPackageConfig() {
        ...
        .setParent("org.example.anji")// 自定义包路径
